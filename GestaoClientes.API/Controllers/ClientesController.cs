...
public sealed class ClientesController : ControllerBase
{
    ...
    private readonly ObtemClientePorIdQueryHandler _obtemClientePorIdHandler;

    public ClientesController(
        CriaClienteCommandHandler criaClienteHandler,
        ObtemClientePorIdQueryHandler obtemClientePorIdHandler)
    {
        _criaClienteHandler = criaClienteHandler;
        _obtemClientePorIdHandler = obtemClientePorIdHandler;
    }
    ...
    public async Task<IActionResult> ObterPorId(Guid id, CancellationToken cancellationToken)
    {
        ...
        var resultado = await _obtemClientePorIdHandler.HandleAsync(query, cancellationToken);
